 ...
 */
function sidebarApp(mode, extra) {
    page            = $('#page-container');
    header          = $('header');
    sidebar         = $('#sidebar');
...
function colorThemePreview(themeColor,themeHeader,themeSidebar) {
        ...
        if (themeColor === 'default') {
            if (themeLink.length) {
                themeLink.attr('href', '../assets/css/themes.css');
            }
        } else {
            if (themeLink.length) {
                themeLink.attr('href', '../assets/css/themes/'+ themeColor);
            } 
        }
}
